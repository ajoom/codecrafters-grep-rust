...
//     patterns: &Vec<RegPattern>,
//     input_ind: usize,
//     pattern_ind: usize,
//     next_char_must_match: bool,
//     last_matched_on_pattern: bool,
// ) -> bool {
...
//             solve(input_chars, patterns, input_ind, pattern_ind + 1, true, false)
//         }
...
//             let matches =
//                 input_ind < input_chars.len() && match_pattern_with_char(&pattern, input_chars[input_ind]);
